...
/** Logo Google resmi (inline SVG, tanpa permintaan jaringan). */
function IkonGoogle() {
  return (
...
export function TombolGoogle({
  ...
  return (
    <Tombol varian="garis" ukuran="lg" className="w-full" onClick={onKlik} memuat={memuat}>
      {!memuat ? <IkonGoogle /> : null}
      {label}
    </Tombol>
  )
}
